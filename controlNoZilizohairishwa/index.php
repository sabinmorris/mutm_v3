  ...
  <div class="content-wrapper text-monospace">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-7">
            <h1>Namba za Ankara (Zilizohairishwa) / Control Numbers (Canceled)</h1>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-content-above-home-tab" data-toggle="pill" href="#zilizohairishwa" role="tab" aria-controls="custom-content-above-home" aria-selected="true">Zilizohairishwa</a>
                  </li>
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="zilizohairishwa" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                     <div class="card">
                      <div class="card-header border-0">
                        <div class="row">
                          ...
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <input type="text" class="form-control form-control-border" id="searchByFullnameCa" placeholder="Jina la mlipaji">
                              <span class="input-group-append">
