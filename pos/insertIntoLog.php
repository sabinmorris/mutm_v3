	...
	//INSERT INTO LOG
		...
		if (isset($_POST['act'])) {
			if ($_POST['act'] == 'insertLog') {
				$insertLog['eventts'] = "Amesajili akaunti namba mpya ".$_POST['accnum']; //get event
			}elseif ($_POST['act'] == 'updateLog') {
				$insertLog['eventts'] = "Amebadilisha taarifa za POS yenye imei namba ".$_POST['imeinumber'] ." kutoka taasisi ya ". $_POST['instname']; //get event
			}else{
				$insertLog['eventts'] = "Amefuta POS yenye imei namba  ".$_POST['imeinumber'] ." kutoka taasisi ya ". $_POST['instname']; //get event
			}
		}
