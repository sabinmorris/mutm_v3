    ...
    //INSERT INTO LOG
        ...
        if (isset($_POST['act'])) {
            if ($_POST['act'] == 'insertLog') {
                $insertLog['eventts'] = "Amesajili hali ya chanzo  cha " . $_POST['ltsname'] . " kwa bei ya " . $_POST['ltsprice'] . ", Aina ya malipo ni ". $_POST['paymenttype']; //get event

            }elseif ($_POST['act'] == 'updateLog') {
                $insertLog['eventts'] = "Amebadilisha jina la chanzo kidogo".$_POST['mdsname']; //get event
            }else{
                $insertLog['eventts'] = "Amefuta hali ya chanzo cha ".$_POST['mdsname']; //get event
            }
        }
