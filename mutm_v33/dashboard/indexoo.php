	              ...
	              <table class="table table-striped table-valign-middle small">
	                ...
	                <tbody>
	                  <?php
	                    ...
	                    $json4 = file_get_contents($ipConnect.'/getTodayDashboradWizarani/'); //receive json from url
	              ...
	              <table class="table table-striped table-valign-middle small">
	                ...
	                <tbody>
	                  <?php
	                    ...
	                    $json4 = file_get_contents($ipConnect.'/getMonthDashboradWizarani/'); //receive json from url
	              ...
	              <table class="table table-striped table-valign-middle small">
	                ...
	                <tbody>
	                  <?php
	                    ...
	                    $jsonChart = file_get_contents($ipConnect.'/getYearDashboradWizarani/'); //receive json from url
	                  ...
	                  <?php
	                    ...
	                    foreach ($arr4 as $key => $value) {
	                      ...
	                      echo '<tr>';
	                        ...
	                        $jsonz = file_get_contents($ipConnect.'/getDashboarCollectionByZone/'.$zoneid);
	                  ...
	                  <?php
	                    ...
	                    foreach ($arr4 as $key => $value) {
	                      ...
	                      echo '<tr>';
	                        ...
	                        $jsonzm = file_get_contents($ipConnect.'/getMonthDashboarCollectionByZone/'.$zoneid);
	                        //receive json from url
	                  ...
	                  <?php
	                    ...
	                    foreach ($arr4 as $key => $value) {
	                      ...
	                      echo '<tr>';
	                        ...
	                        $jsony = file_get_contents($ipConnect.'/getYearDashboarCollectionByZone/'.$zoneid);
	                        //receive json from url
        ...
        w2.draw(new google.visualization.DataTable(
          {cols:[
            ...
            <?php
              ...
              $num = 0;
              // $mksm = 6000000;
              $jsonChart2 = file_get_contents($ipConnect.'/getYearDashboradWizarani/'); //receive json from url
              ...
              foreach ($arrChart2 as $key => $value) {
                ...
                $jsonm = file_get_contents($ipConnect.'/selectAllProjectionByInstitute/'.$instid);
        ...
        w2.draw(new google.visualization.DataTable(
          {cols:[
            ...
            <?php
              //select main source collection for LGA
              $num = 0;
                $jsong = file_get_contents($ipConnect.'/selectMainsourceByInstitute/'.$_SESSION['instituteid']); //receive json from url
                ...
                foreach ($arrg as $key => $valueg) {
                  ...
                  $mks = 0;
                  $jsongg = file_get_contents($ipConnect.'/getYearDashboarCollectionByVyanzo/'.$msidg); //receive json from url
                  ...
                  //find projections by institute
                  $jsonggg = file_get_contents($ipConnect.'/selectProjectionByMainsource/'.$msidg);
