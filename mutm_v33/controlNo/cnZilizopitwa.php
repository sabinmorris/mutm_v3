<thead>
  ...
  <tbody>
    <?php
      $num = 1;
      $totalCnZilizopitwa = 0;
      foreach ($arr as $key => $value) {
        //find totalAmount
        $totalCnZilizopitwa = $totalCnZilizopitwa + $value['totalamount'];
          ...
          echo '<td class = "text-right">';
            ...
            <div class="btn-group">
              ...
              <?php
                ...
                echo '<a data-id="'.$value['referencenumber'].'" data-conf2="'.$value['controlnumber'].'" href="#infoCnR" class="btn btn-default btn-xs open-infoCnR" title="Bonyeza kuruhusu kutumika tena kwa ankara namba"><i class="fas fa-sync-alt"></i>&nbsp;Reuse</a>';
              ?>
            </div>
            <?php
          echo'</td>';
  ...
  <tfoot>
    <tr>
      ...
      <th class="text-center"><?php echo number_format($totalCnZilizopitwa, 2) . ' TZS'; ?></th>
      <th>&nbsp;</th>
      <th>&nbsp;</th>
      <th>&nbsp;</th>
    </tr>
