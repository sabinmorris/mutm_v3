...
//call controlnumber_request_payload
$(document).on("click", ".open-infoCnR", function (e) {
  ...
  var controlnumber = _self.data('conf2');

  $.ajax({
    url:"findReuseBill.php", //CODE TO GET WAITING CN
    type:"POST",
    data:{
      refn:referencenumber,
      cnnumber:controlnumber
    }, //ELEMENT ID WHERE I GET VALUE
      success:function(data){
      $("#reuseCnDiv").html(data); //WHERE RESULT WILL BE DISPLAYED
