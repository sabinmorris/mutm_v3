...
<head>
  ...
  <title>MUTM | Makusanyo kwa Vyanzo Vidogo</title>
  ...
  <div class="content-wrapper text-monospace">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Makusanyo kwa Vyanzo Vidogo</h1>
          </div>
          <div class="col-sm-4">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard/">Nyumbani</a></li>
              <li class="breadcrumb-item active">Makusanyo kwa Vyanzo Vidogo</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      <div class="row">
                        ...
                        <?php
                          if ($_SESSION['urole'] == 'Msimamizi mkuu' || $_SESSION['urole'] == 'Muangalizi mkuu') {
                            ...
                            ?>
                            <input type="hidden" name="instituteidmd" id="instituteidmd" value="<?php echo $_SESSION['instituteid']; ?>">
                            <div class="col-sm-3">
                              <div class="form-group">
                                  <label for="msid">Vyanzo Vikuu
                                    <span class="text-danger">*</span>
                        ...
                        <div class="col-sm-3">
                          <div class="form-group">
                            ...
                            <input type="date" name="startDate" id="startDate" class="form-control" placeholder="Ingiza Tarehe ya mwanzo" style="border: solid 1px green;" onchange="getCollectionByChanzoKidogo()">
                          </div>
                        </div>
                        <div class="col-sm-3">
                          <div class="form-group">
                            <label for="endDate">Tarehe ya mwisho:</label>
                            <input type="date" name="endDate" id="endDate" class="form-control" placeholder="Ingiza Tarehe ya mwisho" style="border: solid 1px green;" onchange="getCollectionByChanzoKidogo()">
                          </div>
                        </div>
                      </div>
                    </form>
                ...
                <table id="example1" class="table table-bordered table-striped small">
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      if ($_SESSION['urole'] == 'Msimamizi mkuu' || $_SESSION['urole'] == 'Muangalizi mkuu') {
                        $json4 = file_get_contents($pubIP.'selectAllMiddlesource/'); //receive json from url
                      }else{
                        $json4 = file_get_contents($pubIP.'selectMiddlesourceByInstitute/'.$_SESSION['instituteid']); //receive json from url
                      }
                      ...
                      foreach ($arr4 as $key => $value) {
                        ...
                        $mdsid = $value['mdsid'];
                        // //find amount by vyanzo vidogo
                        // $json5 = file_get_contents($ipConnect.'/getDashboarCollectionByMiddleSource/'.$mdsid); //receive json from url
                        ...
                        $jsonmy = file_get_contents($pubIP.'getDashboarCollectionByMiddleSource/'.$mdsid);
...
<script type="text/javascript" src="kwa_chanzo_kidogo.js"></script>
</body>
</html>
