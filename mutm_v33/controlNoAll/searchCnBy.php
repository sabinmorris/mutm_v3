<?php
    ...
    if (isset($_POST['searchVal'])) {
        ...
        $cnVal = $_POST['cnVal']; # code...
        $receiptVal = $_POST['receiptVal']; # code...
        $fullnameVal = $_POST['fullnameVal']; # code...
        $phoneVal = $_POST['phoneVal']; # code...

        if ($cnVal != '') {
            $json = file_get_contents($pubIP.'getControllNumberByControlNumber?contnumb='.$cnVal); //receive json from url
        }else{
