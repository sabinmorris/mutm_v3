<?php
    ...
    //INSERT INTO LOG
        ...
        if (isset($_POST['act'])) {
            if ($_POST['act'] == 'updateLog') {
                $insertLog['eventts'] = "Hali ya chanzo " . $_POST['mdsid'] . " - " . $_POST['ltsname'] . "imebadilishwa taarifa zake"; //get event
            }else{
                $insertLog['eventts'] = "Hali ya chanzo cha ".$_POST['ltsname'] . " imefutwa"; //get event
            }
        }
