      ...
      <div class="modal-body">
        <form id="editLittleSourceForm">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label for="sourcetype">Aina ya Chanzo
                  <span class="text-danger">*</span>
                </label>
                <select class="form-control" id="sourcetype" name="sourcetype" required="required" style="border: solid 1px green;">
