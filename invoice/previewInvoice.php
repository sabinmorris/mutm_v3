...
<head>
  ...
  <?php
    ...
    echo $controlnumber = $_GET['controlnumber'];
        ...
        <div class="col-sm-12">
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-sm-12">
                    ...
                    <?php
                      //if ($fstchar == 8) {
                       $jsonS = file_get_contents($publicIPConnent.'mutm/api/getInvoiceByStatus/'.$status.'?&pageNum=1&pageSize=1'); //receive json from url
                      //}
                        ...
                        <tbody>
                          ...
                          foreach ($arrS as $keyS => $valueS) {
                            ...
                            if ($fstchar == 8) {
                              ...
                              // $servicename = $valueS['servicename'];
                              // $servicecode = $valueS['servicecode'];
                              $servicename = $valueS['description'];
                              // $ltsid = $valueS['ltsid'];
                              // $bankcode = $valueS['bankcode'];
                               $serviceamount = $valueS['amount'];
                            }
                    ...
                    <?php
                        ...
                        function convertNumber($num = false)
                        {
                          ...
                          $totalAmountinWord =  convertNumber($serviceamount);
