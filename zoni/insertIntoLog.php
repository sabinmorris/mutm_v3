	...
	//INSERT INTO LOG
		...
		if (isset($_POST['act'])) {
			if ($_POST['act'] == 'insertLog') {
				$insertLog['eventts'] = "Amesajili zoni mpya ".$_POST['zonename']; //get event
			}elseif ($_POST['act'] == 'updateLog') {
				$insertLog['eventts'] = "Jina la zoni ".$_POST['zonename'] . " limebadilishwa"; //get event
			}else{
				$insertLog['eventts'] = "Amefuta zoni ya  ".$_POST['zonename']; //get event
			}
		}
